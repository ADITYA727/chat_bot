...
chat = Chat(os.path.join(os.path.dirname(os.path.abspath(__file__)),"chatbotTemplate","Example.template"),reflections, call=call)
...
def Post(request):
    ...
    if request.method == "POST":
        ...
        if query.lower() in ['bye', 'quit', 'bbye', 'seeya', 'goodbye']:
            ...
            response = response + '<br/>' + '<h3>ChatBot Summary:</h3><br/>' + '<br/><br/>'.join(chat_saved)
